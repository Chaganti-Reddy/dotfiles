...
12. If you are using Vivaldi browser then go to vivaldi://flags/#ozone-platform-hint and make it auto and also go to vivaldi://settings and turn on gtk for dark context menus.
