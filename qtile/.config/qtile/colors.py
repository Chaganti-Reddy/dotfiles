...
WalColors = [
    ["#0f071b", "#0f071b"], # bg
    ["#5C57A2", "#5C57A2"], # fg
    ["#9C269D", "#9C269D"], # color01
    ["#E011A3", "#E011A3"], # color02
    ["#844D9C", "#844D9C"], # color03
    ["#EF1DCF", "#EF1DCF"], # color04
    ["#9C41C6", "#9C41C6"], # color05
    ["#ee9fe9", "#ee9fe9"], # color06
    ["#a66fa3", "#a66fa3"], # color15
    ["#5C57A2", "#5C57A2"], # color09
]
