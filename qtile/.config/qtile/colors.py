...
WalColors = [
    ["#0c0d15", "#0c0d15"], # bg
    ["#626A90", "#626A90"], # fg
    ["#AF708E", "#AF708E"], # color01
    ["#7984AA", "#7984AA"], # color02
    ["#938FB2", "#938FB2"], # color03
    ["#AE95B8", "#AE95B8"], # color04
    ["#DC9AAE", "#DC9AAE"], # color05
    ["#d9ceda", "#d9ceda"], # color06
    ["#979098", "#979098"], # color15
    ["#626A90", "#626A90"], # color09
]
