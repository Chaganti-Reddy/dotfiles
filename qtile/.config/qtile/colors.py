...
WalColors = [
    ["#050608", "#050608"], # bg
    ["#3C4346", "#3C4346"], # fg
    ["#4A5254", "#4A5254"], # color01
    ["#5B605F", "#5B605F"], # color02
    ["#575E60", "#575E60"], # color03
    ["#5B6465", "#5B6465"], # color04
    ["#646C6D", "#646C6D"], # color05
    ["#b4b7b8", "#b4b7b8"], # color06
    ["#7d8080", "#7d8080"], # color15
    ["#3C4346", "#3C4346"], # color09
]
