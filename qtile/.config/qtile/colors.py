...
WalColors = [
    ["#131318", "#131318"], # bg
    ["#F29A06", "#F29A06"], # fg
    ["#D8B51C", "#D8B51C"], # color01
    ["#193B92", "#193B92"], # color02
    ["#055DA4", "#055DA4"], # color03
    ["#0370C6", "#0370C6"], # color04
    ["#339FBB", "#339FBB"], # color05
    ["#7ac2de", "#7ac2de"], # color06
    ["#55879b", "#55879b"], # color15
    ["#F29A06", "#F29A06"], # color09
]
