...
WalColors = [
    ["#090B1E", "#090B1E"], # bg
    ["#6EA1F1", "#6EA1F1"], # fg
    ["#F6BABE", "#F6BABE"], # color01
    ["#9C93F1", "#9C93F1"], # color02
    ["#B091F1", "#B091F1"], # color03
    ["#CE93F0", "#CE93F0"], # color04
    ["#CFA7F6", "#CFA7F6"], # color05
    ["#eec9e9", "#eec9e9"], # color06
    ["#a68ca3", "#a68ca3"], # color15
    ["#6EA1F1", "#6EA1F1"], # color09
]
