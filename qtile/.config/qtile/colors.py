...
WalColors = [
    ["#0c0413", "#0c0413"], # bg
    ["#9E5F65", "#9E5F65"], # fg
    ["#33B05A", "#33B05A"], # color01
    ["#658E79", "#658E79"], # color02
    ["#B29774", "#B29774"], # color03
    ["#715792", "#715792"], # color04
    ["#679E88", "#679E88"], # color05
    ["#98d2c9", "#98d2c9"], # color06
    ["#6a938c", "#6a938c"], # color15
    ["#9E5F65", "#9E5F65"], # color09
]
