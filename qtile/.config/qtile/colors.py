...
WalColors = [
    ["#05030C", "#05030C"], # bg
    ["#E4A403", "#E4A403"], # fg
    ["#D6C508", "#D6C508"], # color01
    ["#1741A5", "#1741A5"], # color02
    ["#055DA5", "#055DA5"], # color03
    ["#CB25A5", "#CB25A5"], # color04
    ["#04A3D2", "#04A3D2"], # color05
    ["#81d6e3", "#81d6e3"], # color06
    ["#5a959e", "#5a959e"], # color15
    ["#E4A403", "#E4A403"], # color09
]
