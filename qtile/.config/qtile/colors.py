...
WalColors = [
    ["#110d09", "#110d09"], # bg
    ["#7A6943", "#7A6943"], # fg
    ["#8C6B39", "#8C6B39"], # color01
    ["#BD7032", "#BD7032"], # color02
    ["#947844", "#947844"], # color03
    ["#AE9151", "#AE9151"], # color04
    ["#CBAF63", "#CBAF63"], # color05
    ["#e5dab1", "#e5dab1"], # color06
    ["#a0987b", "#a0987b"], # color15
    ["#7A6943", "#7A6943"], # color09
]
