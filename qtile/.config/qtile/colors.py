...
WalColors = [
    ["#020101", "#020101"], # bg
    ["#8E2F0C", "#8E2F0C"], # fg
    ["#99200A", "#99200A"], # color01
    ["#A65614", "#A65614"], # color02
    ["#CB620E", "#CB620E"], # color03
    ["#C2452A", "#C2452A"], # color04
    ["#BA8B21", "#BA8B21"], # color05
    ["#e2c281", "#e2c281"], # color06
    ["#9e875a", "#9e875a"], # color15
    ["#8E2F0C", "#8E2F0C"], # color09
]
