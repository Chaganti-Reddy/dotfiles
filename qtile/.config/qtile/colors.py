...
WalColors = [
    ["#050505", "#050505"], # bg
    ["#6E6E6D", "#6E6E6D"], # fg
    ["#B5464D", "#B5464D"], # color01
    ["#84807F", "#84807F"], # color02
    ["#8B8B8B", "#8B8B8B"], # color03
    ["#AEAEAE", "#AEAEAE"], # color04
    ["#EAA0A1", "#EAA0A1"], # color05
    ["#dfdfdf", "#dfdfdf"], # color06
    ["#9c9c9c", "#9c9c9c"], # color15
    ["#6E6E6D", "#6E6E6D"], # color09
]
